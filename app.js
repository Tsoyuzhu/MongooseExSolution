...
app.get('/', function(req,res) {
    ...
    */
    Todo.find({}, function(err, todosFound) {
        ...
        res.render('index', {todosFound:todosFound});
    })
})
...
app.post('/addTodo', function(req,res) {
    ...
    */
    var incomingTodo = req.body.todo;
    console.log(incomingTodo);
    var newTodo = new Todo({task: incomingTodo});
...
app.listen(3000, function() {
    console.log("The mongoose Exercise app is running on locahost:3000");
})